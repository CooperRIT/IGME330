...
function setupCanvas(canvasElement, analyserNodeRef) {
    ...
    gradient = utils.getLinearGradient(ctx, 0, 0, 0, canvasHeight, [{ percent: 0, color: "blue" }, { percent: 1, color: "green" }]);
...
function draw(params = {}) {
    ...
    // `imageData.data` is a Uint8ClampedArray(1288000) typed array that has 1.28 million elements!
